...
INSERT INTO "new_TextMessage" ("animation", "backgroundColor", "createdAt", "dismissedAt", "displayDuration", "fontColor", "fontSize", "id", "imageSize", "imageUrl", "position", "priority", "scheduledAt", "sentAt", "text") SELECT "animation", "backgroundColor", "createdAt", "dismissedAt", "displayDuration", "fontColor", "fontSize", "id", "imageSize", "imageUrl", "position", "priority", "scheduledAt", "sentAt", "text" FROM "TextMessage";
