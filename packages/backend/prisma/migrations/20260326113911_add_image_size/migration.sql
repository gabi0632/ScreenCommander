...
INSERT INTO "new_TextMessage" ("animation", "backgroundColor", "createdAt", "dismissedAt", "displayDuration", "fontColor", "fontSize", "id", "imageUrl", "position", "priority", "scheduledAt", "sentAt", "text") SELECT "animation", "backgroundColor", "createdAt", "dismissedAt", "displayDuration", "fontColor", "fontSize", "id", "imageUrl", "position", "priority", "scheduledAt", "sentAt", "text" FROM "TextMessage";
